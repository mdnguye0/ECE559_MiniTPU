...
REM
REM Generated by Vivado on Thu Mar 26 01:45:07 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_tpu_top_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_tpu_top_vlog.prj -log xvlog.log
