...
REM
REM Generated by Vivado on Fri Mar 06 14:43:26 -0500 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_act_skew_buffer_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_act_skew_buffer_vlog.prj -log xvlog.log
