...
REM
REM Generated by Vivado on Thu Mar 12 23:04:19 -0400 2026
...
echo "xvlog --incr --relax -L uvm -prj tb_weight_path_vlog.prj"
call xvlog  --incr --relax -L uvm -prj tb_weight_path_vlog.prj -log xvlog.log
